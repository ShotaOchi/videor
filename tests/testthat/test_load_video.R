test_that("load_video",
{
  ...
  bees_2to6_step2 <- load_video(bees, c(1,6), step = 2)
  ...
  expect_equal_cimg(bees_2, frames(bees_2to6_step2, 2)[[1]])
  expect_equal_cimg(bees_4, frames(bees_2to6_step2, 4)[[1]])
  expect_equal_cimg(bees_6, frames(bees_2to6_step2, 6)[[1]])
  ...
  expect_equal_cimg(counts_1, frames(counts_all, 1)[[1]])
  expect_equal_cimg(counts_4, frames(counts_all, 4)[[1]])
  expect_equal_cimg(counts_9, frames(counts_all, 9)[[1]])
})
